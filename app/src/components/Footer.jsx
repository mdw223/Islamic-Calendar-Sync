      ...
      <div className="lp-footer-inner">
        <div className="lp-footer-columns">
          ...
          <div className="lp-footer-col">
            ...
            <Link to="/features" className="lp-footer-link">
              Features
            </Link>
            <Link to="/guide" className="lp-footer-link">
              Guide
            </Link>
            <Link to="/methods" className="lp-footer-link">
              Methods
            </Link>
          ...
          <div className="lp-footer-col">
            ...
            <Link to="/privacy" className="lp-footer-link">
              Privacy
            </Link>
            <Link to="/terms" className="lp-footer-link">
              Terms
            </Link>
            <Link to="/data-policy" className="lp-footer-link">
              Data Policy
            </Link>
          </div>
          ...
          <div className="lp-footer-col">
            ...
            <Link to="/contact" className="lp-footer-link">
              Contact Us
            </Link>
            <div className="lp-footer-icons">
              ...
              <a
                className="lp-footer-icon-btn"
                href="mailto:contact@islamiccalendarsync.com"
                aria-label="Email contact@islamiccalendarsync.com"
              >
                <svg
                  width="18"
                  height="18"
